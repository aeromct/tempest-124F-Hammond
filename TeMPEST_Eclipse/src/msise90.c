/* msise90.f -- translated by f2c (version 20100827).
	...
	mass, real *d__, real *t)
{
    ...
    extern real vtst_(integer *, real *, real *, real *, real *, real *, real 
	    *, real *, integer *);
    extern /* Subroutine */ int glatf_(real *, real *, real *);
    extern real densm_(real *, real *, real *, real *, integer *, real *, 
	    real *, real *, integer *, real *, real *, real *), glob6s_(real *
	    );
...
/* ----------------------------------------------------------------------- */
real vtst_(integer *iyd, real *sec, real *glat, real *glong, real *stl, real *
	f107a, real *f107, real *ap, integer *ic)
{
    /* Initialized data */
	 ...
	 integer *mass, real *d__, real *t, logical *meter)
{
    ...
    extern real vtst_(integer *, real *, real *, real *, real *, real *, real 
	    *, real *, integer *), densu_(real *, real *, real *, real *, 
...
/* ----------------------------------------------------------------------- */
real globe6_(real *yrd, real *sec, real *lat, real *long__, real *tloc, real *
...
/* Computing 19th power */
    ...
    lpoly_1.apt[0] = (ap[2] - 4.f + (p[26] - 1.f) * (ap[2] - 4.f + (exp(-abs(
	    ...
	    r__6 * (r__5 * r__5)) / (1.f - exp1) * pow_dd(&d__1, &c_b104));
/* Computing 3rd power */
    r__1 = exp2;
/* Computing 4th power */
    r__2 = exp2, r__2 *= r__2;
...
/* Computing 19th power */
    ...
    lpoly_1.apt[2] = (ap[2] - 4.f + (p[26] - 1.f) * (ap[2] - 4.f + (exp(-abs(
	    ...
	    r__6 * (r__5 * r__5)) / (1.f - exp2) * pow_dd(&d__1, &c_b104));
    if (csw_1.sw[8] == 0.f) {
	goto L40;
    }
...
/*        SW FOR MAIN TERMS, SWC FOR CROSS TERMS */
	...
	if ((r__1 = sv[i__], abs(r__1)) == 1.f || (r__2 = sv[i__], abs(r__2)) 
		== 2.f) {
	    csw_1.swc[i__ - 1] = 1.f;
	} else {
	    csw_1.swc[i__ - 1] = 0.f;
...
/* -------------------------------------------------------------------- */
real densu_(real *alt, real *dlb, real *tinf, real *tlb, real *xm, real *
...
/* -------------------------------------------------------------------- */
real densm_(real *alt, real *d0, real *xm, real *tz, integer *mn3, real *zn3, 
	real *tn3, real *tgn3, integer *mn2, real *zn2, real *tn2, real *tgn2)
{
    /* Initialized data */
...
/* ----------------------------------------------------------------------- */
real dnet_(real *dd, real *dm, real *zhm, real *xmm, real *xm)
{
    /* System generated locals */
    real ret_val;
    doublereal d__1, d__2;
...
/* ----------------------------------------------------------------------- */
real ccor_(real *alt, real *r__, real *h1, real *zh)
{
    /* System generated locals */
    real ret_val;
