/*****************************************************************************/
/*                                                                           */
/*   Module:	binarifytail.c                                               */
/*                                                                           */
/*   Purpose:	This program determine if a file is binarified or not and    */
/*		if so, prints the desired value from the last entry.         */
/*                                                                           */
...
/*                                                                           */
/*   RCS:	$Id: binarifytail.c,v 1.5 1996/03/14 22:55:39 nestorv Exp $                                                        */
/*                                                                           */
/*		$Log: binarifytail.c,v $
 ...
 * Added -fmt option.
 *
 * Revision 1.3  1995/11/07  17:35:59  nestorv
 * Fixed inconsistencies.
 *
 * Revision 1.2  1995/11/07  15:56:45  nestorv
 *  Can read data from STDIN too.
 *
 * Revision 1.1  1995/11/03  07:54:38  nestorv
 * Initial revision
 *                                                       */
/*                                                                           */
/*****************************************************************************/
...
{
   fprintf (stderr, "\007\n%s\n",
" Usage: binarifytail	-f <input filename> -col <desired column of value>") ;
   fprintf (stderr, "%s\n\n",
...
"			then the number in the specified column is printed") ;
   fprintf (stderr, "%s\n\n",
"			in double or GMT format from the last entry.") ;
}
...
void main (int argc, char *argv[])
{
   ...
   if (bcmp (firstfour, "$P\r\n", 4) == 0)
   {
      ...
      fread (&num_comm, sizeof (short), 1, fin) ;
                                   ...
                                   /* Go to the end of file end back up one  */
                                   /*  record                                */
      fseek (fin, -1 * num_cols * sizeof (double), SEEK_END) ;
                                   /* Read in last record                    */
